...
//             <h1 class="font-display text-3xl font-semibold text-white">Beauty</h1>
//             <p class="font-body mb-3 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
//               Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis
//               dolore adipisci placeat.
//             </p>
//             <button class="rounded-full bg-neutral-900 py-2 px-3.5 font-body text-sm capitalize text-white shadow shadow-black/60">
//               See More
//             </button>
//           </div>
//         </div>
